...
/*
 * La classeNeuron modÈlise un neurone. Chaque neurone n aura deux listes : la liste des neurones
 * "sources", i.e. les neurones qui enverront les entrÈes ‡ n et la liste des neurones "destinataires", i.e.
...
public class Neuron {
	 ...
	 */
	public void feed(){
		// to be completed//la somme pond√©r√©e de ses entr√©es// utilisation de ses parents 
		double somP=0;
		for( Neuron n: parents){
