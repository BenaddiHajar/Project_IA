 ...
 * @author stephane
 * 
 * La classe abstraite ANN (pour Articial Neural Network) contient la description du r�seau de neu-rones. 
 * Elle d�crit les di�rentes couches de neurones. En particulier, tout r�seau doit avoir la couche d�entr�e 
 * (inLayer) et la couche de sortie (outLayer). La classe contient aussi les donn�es pour en-trainer 
 * le r�seau (trainingData) et pour tester le r�seau (testingData). Pour vos r�seaux, il faudra 
